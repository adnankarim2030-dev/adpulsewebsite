        ...
        <div className="portfolio-grid">
          ...
          <div className="portfolio-item">
            <div className="portfolio-img">
              <span className="placeholder-text">FITFUEL</span>
            </div>
          ...
          <div className="portfolio-item">
            <div className="portfolio-img">
              <span className="placeholder-text">BURGER HOUSE</span>
            </div>
            <div className="portfolio-content">
          ...
          <div className="portfolio-item">
            <div className="portfolio-img">
              <span className="placeholder-text">URBAN PEAKS</span>
            </div>
            <div className="portfolio-content">
          ...
          <div className="portfolio-item">
            <div className="portfolio-img">
              <span className="placeholder-text">TECHNOVA</span>
            </div>
            <div className="portfolio-content">
