    ...
    <div className="page-wrapper">
      ...
      <section className="container section-padding">
        <div className="about-grid">
          ...
          <div className="about-image bg-dark">
            <span className="placeholder-text">AGENCY COLLAGE</span>
          </div>
        </div>
      </section>
      ...
      <section className="founder-section bg-gradient-gray section-padding">
        <div className="container">
          <div className="founder-grid">
            <div className="founder-image bg-dark">
              <span className="placeholder-text">KHURRAM JAFFRANI</span>
            </div>
        ...
        <div className="container">
          ...
          <div className="team-grid">
            ...
            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Noel</span></div>
              <h3>Noel Francis</h3>
            ...
            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Shoaib</span></div>
            ...
            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Naeem</span></div>
              <h3>Naeem Ahmed</h3>
            ...
            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Kashif</span></div>
              <h3>Kashif Aghani</h3>
            ...
            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Syed Abeel</span></div>
              <h3>Syed Abeel Ahmed</h3>
              <span className="team-role">Creative Manager</span>
              <div className="team-details">
                <p><strong>Experience:</strong> 7 Years +</p>
                <p><strong>Expertise:</strong> Branding, Layouting, Animation, Corporate Comms</p>
              </div>
            </div>

            <div className="team-card">
              <div className="team-photo bg-dark"><span className="placeholder-text">Adnan</span></div>
              <h3>Adnan Karim</h3>
              <span className="team-role">Digital Marketing Mgr</span>
              <div className="team-details">
                <p><strong>Experience:</strong> 15 Years +</p>
                <p><strong>Expertise:</strong> Digital Marketing, Social Media, BTL, Ai Creative Ads</p>
              </div>
            </div>
